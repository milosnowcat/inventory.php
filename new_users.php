    ...
    <main class="main">
        ...
        <section class="contact section" id="contact">
            ...
            <div class="contact__container container grid">
                <div>
                    <form method="post" action="add_users.php" class="contact__form grid">
                    <div class="contact__inputs grid">
                        <div class="contact__content">
                            <label for="" class="contact__labe">Username</label>
                            <input type="text" class="contact__input" name="user" id="user">
                        </div>
                        <div class="contact__content">
                            <label for="" class="contact__labe">Password</label>
                            <input type="text" class="contact__input" name="pass" id="pass" value="<?php echo randomPassword() ?>">
                        </div>
                        <div class="contact__content">
